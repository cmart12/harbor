    ...
    case 'running':
      return (
        <svg className="agent-icon-svg agent-icon-running" width="18" height="18" viewBox="0 0 18 18" fill="none">
          <circle cx="9" cy="9" r="8" stroke="var(--color-accent)" strokeWidth="2" strokeDasharray="12 38" strokeLinecap="round">
            <animateTransform attributeName="transform" type="rotate" from="0 9 9" to="360 9 9" dur="0.8s" repeatCount="indefinite" />
          </circle>
          <circle cx="9" cy="9" r="4" fill="var(--color-accent)" opacity="0.3" />
        </svg>
      );
    case 'waiting-approval':
      return (
        <svg className="agent-icon-svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
          <circle cx="9" cy="9" r="8" fill="var(--color-warning)" opacity="0.15" stroke="var(--color-warning)" strokeWidth="1.5" />
          <circle cx="9" cy="9" r="3.5" stroke="var(--color-warning)" strokeWidth="1.5" fill="none" />
          <path d="M9 7V9.5L10.5 10.5" stroke="var(--color-warning)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      );
    case 'completed':
      return (
